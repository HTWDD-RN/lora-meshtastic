...
\end{figure}
	...
	\vspace{1.5cm}
	{\huge\bfseries Textgeneration\par}
	{\huge\bfseries mithilfe von Keras und Tensorflow\par}
	\vspace{1.5cm}
	...
	Prof. Dr. rer. nat. ~Boris \textsc{Hollas}
...
Es soll als Maschinelles Lernverfahren ein zeichenbasiertes, Rekurrentes Neurales Netzwerk erstellt werden, welches anhand von selbst gewählten und beschafften Trainingsdaten das nächste Zeichen einer Sequenz errät.\newline \newline
Who is the Audience? (scientific background or no point of contact before or just a bit?)
