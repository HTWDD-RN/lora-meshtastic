...
\subsubsection{iOS}
\begin{tabular}[h]{l  l  l}
\includegraphics[scale=0.2]{./Bilder/Software/ios/messages.png} & \includegraphics[scale=0.2]{./Bilder/Software/ios/messages_channels.png} & \includegraphics[scale=0.2]{./Bilder/Software/ios/messages_channels.png}\\
...
\\
Aktuell ist Meshtastic noch softwareseitig auf Netzwerke mit bis zu 80 Nodes limitiert. Das reicht bei Weitem nicht, um den Raum Dresden vollständig abzudecken.
