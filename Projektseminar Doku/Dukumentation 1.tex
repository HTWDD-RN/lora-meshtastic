...
\begin{tabular}[h]{l | l | l}
\includegraphics[scale=0.1]{./Bilder/Praxistest/IMG_5287.png} & \includegraphics[scale=0.1]{./Bilder/Praxistest/IMG_5289.png} & \includegraphics[scale=0.1]{./Bilder/Praxistest/IMG_5290.png}\\
TEXT & TEXT & TEXT\\
\end{tabular}\\
